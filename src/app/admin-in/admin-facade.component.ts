...
export class AdminFacadeComponent implements OnInit {
  ...
  getAllCustomers() {
    this.adminService.getAllCustomers(this.token).subscribe(response => {
      this.users = response;
      console.log(this.users);
      this.allFalse();
      this.custArrFlag = true;
  ...
  getAllCompanys() {
    this.adminService.getAllCompanys(this.token).subscribe(response => {
      this.users = response;
      console.log(this.users);
      this.allFalse();
      this.compArrFlag = true;
  ...
  getAllIncome() {
    this.adminService.getAllIncomes(this.token).subscribe(response => {
